...
<html lang="es">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-118628480-2"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-118628480-2');
        </script>
            ...
            <div class="container">
                ...
                <div class="row pricing-tables">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="pricing-table">
                            <div class="pricing-details">
                                <h2 style="align:center">Alojamientos Turísticos</h2>
                                <p>Disfruta de las mejores experiencias en los hoteles del Quindío al mejor precio.</p>
                            ...
                            <div class="contact-us">
                                <div class="contact-address text-center">
                                    ...
                                    <p>
                                        ...
                                        <br> Celular: <strong><a href="https://api.whatsapp.com/send?phone=573143532716&text=Hola,%20quisiera%20conocer%20más%20acerca%20de%20sus%20servicios.%20Podrían%20brindarme%20más%20información?">+57 314 3532716</a></strong>
                                        <br> ¿Nos visita desde un celular?
                                        <br> Háblenos a nuestro Whatsapp: <strong><a href="https://api.whatsapp.com/send?phone=573143532716&text=Hola,%20quisiera%20conocer%20más%20acerca%20de%20sus%20servicios.%20Podrían%20brindarme%20más%20información?">Clic aquí</a></strong>
                                    </p>
                                    <p>Direccion: Armenia Quindío
                                        <br> Carrera 14 #23-15
                                        <br> Camara de comercio, local 9.
                                    </p>
                        ...
                        @php
                            ...
                            <div class="contact-block">
                                ...
                                <div class="form-group {{ $errors->has('telefono') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        {!! Form::text('telefono','', ['class' => 'form-control', 'placeholder' => 'Ingrese su número de teléfono ', 'required' => 'required']) !!} @if ($errors->has('telefono'))
                                        <span class="help-block">
        										<strong>{{ $errors->first('telefono') }}</strong>
        									</span> @endif
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('correo') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        {!! Form::text('correo','', ['class' => 'form-control', 'placeholder' => 'Ingrese su dirección de correo electrónico', 'required' => 'required']) !!} @if ($errors->has('correo'))
                                        <span class="help-block">
        	                                    <strong>{{ $errors->first('correo') }}</strong>
        	                                </span> @endif
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('detalles') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        {!! Form::textArea('detalles','', ['class' => 'form-control editor', 'placeholder' => 'Ingrese sus detalles de la solicitud, como por ejemplo: día de llegada, sitio turístico que le gustaría visitar, lugar de hospedaje, lugar de arrivo. entre otros.',
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-6 col-xs-12">
                        <div class="copyright">
                            <p>Todos los derechos reservados &copy; {{ date('Y') }} - Plantilla Desarrollada por <a rel="nofollow" href="https://uideck.com">UIdeck</a> - Modificación y adaptación realizada por Andrés David Montoya,Luis Felipe Hernández Gomez y Alba Lucia Montoya Hernandez .</p>
                        </div>
                    </div>
                </div>
            </div>
